...
{
    public class DictionaryCloningKeyJH<TValue> : DictionaryCloningKey<JsHandle, TValue>
    {
    }

    public class DictionaryCloningValueJH<TKey> : DictionaryCloningValue<TKey, JsHandle>
    {
    }

    public class DictionaryCloningKey<TKey, TValue> : IDictionary<TKey, TValue>, IDisposable
    where TKey : IDisposable, IClonable<TKey>
    {
        ...
        {
            var keyNew = key.Clone();
            var res = _dict.TryAdd(keyNew, value);
            if (!res)
            {
                keyNew.Dispose();
            }
