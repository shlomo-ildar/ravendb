...
function map(name, lambda) {
    ...
    public abstract partial class AbstractJavaScriptIndex : AbstractJavaScriptIndexBase
    {
        ...
        {
            EngineHandle.SetGlobalClrCallBack("load", (LoadDocumentJint, LoadDocumentV8));
            EngineHandle.SetGlobalClrCallBack("cmpxchg", (LoadCompareExchangeValueJint, LoadCompareExchangeValueV8));
