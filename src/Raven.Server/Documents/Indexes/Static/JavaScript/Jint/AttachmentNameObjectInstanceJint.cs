...
{
    public class AttachmentNameObjectInstanceJint : ObjectInstanceBaseJint
    {
        ...
        public AttachmentNameObjectInstanceJint(Engine engine, BlittableJsonReaderObject attachmentName) : base(engine)
        {
